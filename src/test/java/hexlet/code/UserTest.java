...
import hexlet.code.utils.TestUtilsAction;
...
public class UserTest {
    ...
    static void beforeAll() throws Exception {
        testData = TestUtilsAction.getTestData();
    }
/*
    @Test
    @Order(1)
    ...
    void testListUsers() throws Exception {
        TestUtilsAction.prepareUsers(mockMvc);
        List<Map> loadedUsers = TestUtilsAction.getUsers();
    ...
    void testShowUser() throws Exception {
        ...
        Map<String, Map> usersData = testData.get("users");
        Map<String, String> existingUserData = usersData.get("existing");
        var token = TestUtilsAction.login(mockMvc, existingUserData);
        var existingUserId = TestUtilsAction.getUserIdByEmail(mockMvc, existingUserData.get("email"));
